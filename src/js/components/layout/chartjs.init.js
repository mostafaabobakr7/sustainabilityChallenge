export default function charts() {
  ...
  let chart1 = new Chart(ctx1).LineAlt(data1, {
  ...
  let chart2 = new Chart(ctx2).Bar(data2, {
  ...
  let myPolarArea = new Chart(ctx5).PolarArea(data5, {
  ...
  let myRadarChart = new Chart(ctx6).Radar(data6, {
    scaleShowLine: true,
